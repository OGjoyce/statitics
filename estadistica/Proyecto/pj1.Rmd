...
test['label']
```
#Cada digito contiene 4000 observaciones, cada fila de 784 pixeles 
#PLOT DIGITS BY ROWS
...
#Grafica de barras,
```{r}
barplot(table(train[,1]), col="darkgreen", main="n Digits in Train")
```



#Preparar datos y Normalizacion [0-255] ->[0,1]
```{r}
...
plotResults(1:9, m1.preds.value)
```
